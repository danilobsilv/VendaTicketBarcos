...
import controller.Registrar_Funcionario_Controller;

/**
 *
 * @author PauloR
 */
public class Registrar_Funcionario extends javax.swing.JFrame {

    private final Registrar_Funcionario_Controller controller;
    private  ArrayList<Client> funcionarios = new ArrayList<>();
    MainManager main_manager = new MainManager();

    /**
     * Creates new form Registrar_Funcionario
     */
    public Registrar_Funcionario() {
        initComponents();
        controller = new Registrar_Funcionario_Controller(this);
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) throws IOException {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(user_password.equals(user_passwordConfirmation)){
            ...
            try{
                ...
                FileOutputStream fout = new FileOutputStream("sistema_venda_bilhetes_naval/funcionariosCadastrados.txt");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Registrar_Funcionario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Registrar_Funcionario().setVisible(true);
            }
        });
    }
